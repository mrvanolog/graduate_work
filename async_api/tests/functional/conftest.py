...
from settings import (API_HOST, API_PORT, API_V1_PREFIX, ELASTIC_HOST,
                      ELASTIC_PORT, REDIS_HOST, REDIS_PORT, REDIS_TEST_DB)
...
@pytest.fixture(scope='session')
def api_base_url():
    return f'http://{API_HOST}:{API_PORT}/{API_V1_PREFIX}'
